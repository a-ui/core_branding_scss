...
```
<link rel="stylesheet" href="https://cdn.antwerpen.be/core_branding_scss/7.0.0-beta.9/main.min.css">
```

You can even import it directly in your (S)CSS:

```
@import url("https://cdn.antwerpen.be/core_branding_scss/7.0.0-beta.9/main.min.css");
```
