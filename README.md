...
```
<link rel="stylesheet" href="https://cdn.antwerpen.be/core_branding_scss/7.1.0-beta.1/main.min.css">
```

You can even import it directly in your (S)CSS:

```
@import url("https://cdn.antwerpen.be/core_branding_scss/7.1.0-beta.1/main.min.css");
```
